export default function Footer() {
  ...
  return (
    <footer className="py-8 bg-card-dark border-t border-gray-800">
      <div className="container">
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© {currentYear} Kolawole Iwalewa. All rights reserved.</p>
          <p className="mt-2">
            Built with React, TanStack Router, and Tailwind CSS v4
          </p>
        </div>
      </div>
    </footer>
